...
// ConnectHandler builds a Connect service registration from a generated Connect
// handler constructor and service implementation.
func ConnectHandler[T any](
	...
	return Connect(name, func(options ...connect.HandlerOption) (string, http.Handler) {
		return newHandler(implementation, options...)
	}, opts...)
}
